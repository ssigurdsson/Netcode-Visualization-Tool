...
import os
import pygame as pg
import netblob_server
from netblob_entities import Player, Orb
...
class ServerGame:
    ...
    def __init__(self):
        ...
        self.server = netblob_server.Server()
        self.players = {}
        self.orbs = []
    ...
    def _get_server_observer(self):
        ...
        observer.scale = WIDTH/DEFAULT_WINDOW_SIZE[0]  # Sets the view scale
        return observer
    ...
    def _get_player_view_range(self, player):
        x_range = (player.scale*BASE_WIDTH/2)
        y_range = (player.scale*BASE_HEIGHT/2)
